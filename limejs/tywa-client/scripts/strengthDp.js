goog.provide("tywa.strengthDp");

goog.require("lime.Sprite");

tywa.strengthDp = function(x, y) {
	goog.base(this);

	this.setSize(tywa.STRENGTH_W, tywa.STRENGTH_H).
		setPosition(x, y).
		setAnchorPoint(0, 0);

	this.placeHolder = new lime.Sprite().
		setSize(tywa.STRENGTH_W, tywa.STRENGTH_H).
		setPosition(0, 0).
		setAnchorPoint(0, 0).
		setFill(ui.spriteSheet.getFrame("StrengthBar1.png"));
...
goog.inherits(tywa.strengthDp, lime.Sprite);
